            ...
            <div className="row align-items-center">
                ...
                <div className="col-lg-6 text-center text-lg-start">
                    ...
                    <p className="text-muted mb-4">
                        Personalized tutoring services designed to help students excel in their studies.
                        Our expert tutors provide guidance, support, and the tools needed for academic success.
                    </p>
